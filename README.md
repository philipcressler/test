...
## How to get started
1. Clone or [download](https://github.com/freeshifter/vanguard-digital/archive/master.zip "Download the WP Tailwind Zip") the project onto your `themes` directory `(./wp-content/themes)`
